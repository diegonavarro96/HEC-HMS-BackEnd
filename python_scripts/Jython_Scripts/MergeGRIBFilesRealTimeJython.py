...
OUTPUT_DSS_PATH = os.environ.get('VORTEX_OUTPUT_DSS_PATH', '/mnt/d/Floodace Projects/HEC-HMS-BackEnd/hms_models/LeonCreek/Rainfall/RainfallRealTime.dss')
VARIABLES = ["MultiSensor_QPE_01H_Pass1_altitude_above_msl"]  # Update with actual variables from variablesv3
...
def collect_grib_files(folder_path):
    ...
    for filename in os.listdir(folder_path):
        if "01H_Pass1" in filename and not "latest" in filename and filename.lower().endswith((".grb2", ".grib2")):
